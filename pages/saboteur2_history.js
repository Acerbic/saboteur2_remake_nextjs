...
const footer = "История Saboteur 2. Интересные факты и все что с этим связано."

export default () => (
    <Layout {...{footer, title}} id="article-history" className="mono-column">
        <h1>История</h1>
        ...
        <figure>
            ...
            <img src="static/images/clive_townsend1.jpg" className="bordered" alt=""/>
        ...
        <figure>
            ...
            <img src="static/images/durell_team.jpg" className="bordered" alt=""/>
        ...
        <figure id="sab1-images">
            ...
            <img src="static/images/sab1_1.png" className="bordered" alt=""/>
            <img src="static/images/sab1_2.png" className="bordered" alt=""/>
            <img src="static/images/sab1_3.png" className="bordered" alt=""/>
        </figure>
    </Layout>
)