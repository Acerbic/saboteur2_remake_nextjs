...
class ImageMap2 extends React.Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        // dynamic import
        import('./olMods')
            .then(({ olMap, olView, ImageLayer, TileLayer, TileImage, TileGrid, defaultControls, FullScreen, XYZ }) => {
